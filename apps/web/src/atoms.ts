...
import { fetchAiModels, fetchHealth, fetchPlanning, fetchSettings, fetchWeek } from "./api.ts"
...
export const planningAtom = Atom.family((date: string) => Atom.make(fetchPlanning(date)))
