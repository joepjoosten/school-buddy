...
import { defaultSettings } from "@school-buddy/shared"
...
describe("isQuietTime", () => {
  const wrapping: Settings = { ...defaultSettings, quietStart: "21:00", quietEnd: "07:30" }
  ...
  test("quiet window within one day", () => {
    const daytime: Settings = { ...defaultSettings, quietStart: "12:00", quietEnd: "13:00" }
